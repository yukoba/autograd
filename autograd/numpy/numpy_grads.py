...
anp.power.defgrad(lambda ans, x, y : unbroadcast(ans, x, lambda g : 0 if y == 0 else g * y * x ** (y - 1)))
anp.power.defgrad(lambda ans, x, y : unbroadcast(ans, y, lambda g : 0 if x == 0 else g * anp.log(x) * x ** y), argnum=1)
